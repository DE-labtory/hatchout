...
module.exports = function(_contractAddr = '') {
  abi = fs.readFileSync(path.join(__dirname, '../abi/', 'MockGhostOwnership.json'), {'encoding': 'utf8'});
  ...
  return {
    ...
    methods: {
      ...
      approvedFor: function(_approved, _tokenId, ) {
        return contract.methods.approvedFor(_approved, _tokenId, ).call();
      },
