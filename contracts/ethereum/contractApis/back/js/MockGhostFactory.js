...
module.exports = function(_contractAddr = '') {
  abi = fs.readFileSync(path.join(__dirname, '../abi/', 'MockGhostFactory.json'), {'encoding': 'utf8'});
  ...
  return {
    ...
    methods: {
      ...
      getSignature: function(_tokenId, _signature, ) {
        return contract.methods.getSignature(_tokenId, _signature, ).call();
      },
